...
export function ProjectDetail({ project }: ProjectDetailProps) {
  ...
  return (
    <article className="project-detail" data-testid="project-detail">
      <SectionTheme theme="void" as="div" className="layout-section project-detail__top">
        <Container>
      ...
      <SectionTheme theme="violet" as="div" className="layout-section project-detail__content">
        <Container>
